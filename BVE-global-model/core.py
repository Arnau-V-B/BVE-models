"""
This module contains all the functions and routines required to run the nonlinear BVE simulation
globally over the sphere starting from an initial vorticity or streamfunction field.
